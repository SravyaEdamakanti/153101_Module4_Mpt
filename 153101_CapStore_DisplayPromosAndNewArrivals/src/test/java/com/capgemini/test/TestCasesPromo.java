...
public class TestCasesPromo {
	...
	PromoCode promocode =new PromoCode();
		...
		@Test
		public void newProductDisplay(String name) throws ProductNotFoundException {
		List<Product> pro=promoservice.newProductsDisplay(name);
		assertEquals(false,pro.isEmpty());
		}
		
	    @Test(expected=NullPointerException.class)
	    public void whenProductListisEmpty(String name) throws ProductNotFoundException {
		List<Product> product=promoservice.newProductsDisplay(name);
